...
/** **************************** Import API ****************************** */
import { deleteJobPost } from "../../api/delete";
...
const JobPostList = (props) => {
  ...
  const [selectedUserData] = useState([]);
...
// console.log("prpos apiaaa", props.apiPage);
  const getUserBySearchQuery = (search) => {
    props.getUserBySearchQuery(search);
  };
  // console.log("Are you sure want to delete!!!  ", deleteId);
        ...
        >
          ...
          <CModalFooter>
            <CButton
              ...
              onClick={() => {
                setWarning(!warning);
                deleteJobPost(deleteId).then((res) => {
      ...
      {clickId ? (
        ...
        >
          <CModalHeader
            ...
            closeButton
          >
            <CModalTitle style={{ color: "white" }}>Applied Users</CModalTitle>
          </CModalHeader>
          <CModalBody>
            <User
              userId={userId}
...
const mapStateToProps = (state) => ({
  createJobPostResponse: state.GetJobPostList?.jobpostResponse,
  createJobPostError: state.GetJobPostList?.error,
  createJobPostPreLoader: state.GetJobPostList?.loading,
  preLoader: state.GetJobPostList?.loading,
});

export default connect(mapStateToProps)(JobPostList);